# =============================================================================
# TO_EXTRACTOR v6.0 - UPLOAD ROUTER
# =============================================================================
...
async def upload_pdf(
    ...
    try:
        ...
        return {
            "success": result['status'] in ('OK', 'DUPLICATO'),
            "data": result,
...
def _get_result_message(result: Dict) -> str:
    ...
    if result['status'] == 'OK':
        ...
        if dup_info:
            ...
            return f"⚠️ DOCUMENTO GIÀ PRESENTE: {info} - Stato: {stato_desc}"
        return "⚠️ PDF già caricato precedentemente"
    else:
