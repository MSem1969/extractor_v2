# =============================================================================
# TO_EXTRACTOR v7.0 - LISTINI ROUTER
# =============================================================================
...
async def import_listino(
    ...
    try:
        ...
        # Calcola prezzi se richiesto
        if calcola_prezzi and result['imported'] > 0:
            calc_result = aggiorna_prezzi_netti(vendor_upper, formula)
            result['prezzi_calcolati'] = calc_result
