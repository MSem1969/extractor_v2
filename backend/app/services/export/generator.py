# =============================================================================
# TO_EXTRACTOR v7.0 - EXPORT GENERATOR
# =============================================================================
...
def valida_e_genera_tracciato(
    ...
    if validazione_massiva:
        ...
        if not dettagli:
            return {
                'success': False,
                'error': 'Nessuna riga con quantita da esportare. Confermare le righe prima.'
            }
    else:
        ...
        if not dettagli:
            return {
                'success': False,
                'error': 'Nessuna riga con quantita da evadere > 0. Inserire prima le quantita nella colonna "Da Evadere".'
            }
