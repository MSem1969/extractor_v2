# =============================================================================
# TO_EXTRACTOR v8.0 - ESPOSITORE SERVICE
# =============================================================================
    ...
    for riga in righe_raw:
        ...
        if tipo in ['PRODOTTO_STANDARD', 'PROMO_AUTONOMA', 'CHILD_ESPOSITORE']:
            if ctx.espositore_attivo:
                ...
                # v3.2: Logica chiusura differenziata per vendor
                should_close = False
                if vendor.upper() == 'MENARINI':
                    # MENARINI: chiudi quando somma netto child >= netto parent
                    # menarini_netto_parent è il prezzo netto della riga parent
                    if menarini_netto_parent > 0 and ctx.espositore_attivo.valore_netto_accumulato >= menarini_netto_parent:
                        should_close = True
                else:
