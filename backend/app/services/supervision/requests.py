# =============================================================================
# TO_EXTRACTOR v7.0 - SUPERVISION REQUESTS
# =============================================================================
...
def crea_richiesta_supervisione(
    ...
    Rileva automaticamente il tipo di anomalia (ESPOSITORE/LISTINO/LOOKUP)
    ...
    """
    tipo_anomalia = anomalia.get('tipo_anomalia', '')
    codice_anomalia = anomalia.get('codice_anomalia', '')

    # v8.0: Rileva se anomalia lookup (LKP-A01, LKP-A02)
...
def _crea_supervisione_listino(
    ...
    # Trova id_dettaglio dalla riga ordine
    id_dettaglio = None
    if codice_aic:
        det_row = db.execute("""
...
def sblocca_ordine_se_completo(id_testata: int):
    ...
    Verifica che tutte le supervisioni (espositore, listino e lookup) siano state gestite,
    ...
    total_pending = pending_esp + pending_listino + pending_lookup
