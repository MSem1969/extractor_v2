// =============================================================================
// TO_EXTRACTOR v7.0 - ANOMALIE TAB COMPONENT
// =============================================================================

import React from 'react';
import { Button } from '../../common';
import { getLivelloColor } from './utils';
...
function AnomaliaCard({ anomalia, onLoadDetail, onRisolvi }) {
  const isAperta = anomalia.stato === 'aperta' || anomalia.stato === 'APERTA';
        ...
        <div className="flex items-center gap-2">
          ...
          {isAperta && (
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation();
                onRisolvi(anomalia.id_anomalia || anomalia.id);
              }}
            >
              Risolvi
            </Button>
