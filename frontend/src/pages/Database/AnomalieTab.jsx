// =============================================================================
// TO_EXTRACTOR v7.0 - ANOMALIE TAB COMPONENT (DATABASE PAGE)
// =============================================================================

import React from 'react';
import { anomalieApi } from '../../api';
import { getTipoAnomaliaColor, getSeveritaColor, getStatoAnomaliaColor } from './utils';
            ...
            <tbody>
              {anomalieList.map((anomalia) => (
                ...
                >
                  ...
                  <td className="p-3">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${getSeveritaColor(anomalia.severita)}`}>
