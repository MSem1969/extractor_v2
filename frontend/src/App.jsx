...
import SupervisionePage from "./pages/SupervisionePage";
...
export default function App() {
  ...
  const getMenu = () => {
    // v6.2.1: Permessi menu per ruolo (v9.0: backup spostato in Impostazioni)
    const PERMESSI_MENU = {
      admin: ['dashboard', 'upload', 'database', 'supervisione', 'tracciati', 'settings'],
  ...
  const getPageTitle = () => {
    const titles = {
      ...
      // backup: spostato in tab Impostazioni (v9.0)
  ...
  const renderPage = () => {
    switch (page) {
      ...
      // case "backup": spostato in tab Impostazioni (v9.0)
      case "settings":
